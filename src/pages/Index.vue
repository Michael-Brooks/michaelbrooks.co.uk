<template>
    <Layout :show-logo="false" class="bg-black">
        <div class="p-6">
            <!-- Author intro -->
            <div class="m-24 h-24 pt-6">
                <g-image alt="Author image" class="portrait float-left" src="~/assets/images/author.jpg" width="180"
                         height="180"
                         blur="5"/>
                <span>
                    <p class="text-white ml-56 pt-12 text-xl">I'm a freelance website developer <br>
        ...
        <div class="hero relative">
            ...
            <a href="https://twitter.com/MBrooksUK" title="My personal Twitter account" class="twitter absolute">
            ...
            <a href="https://www.facebook.com/MBrooksDeveloper" title="My personal Facebook account" class="facebook absolute">
                <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://github.com/Michael-Brooks" title="My personal GitHub account" class="github absolute">
                <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://michaelbrooks.substack.com/" title="Join my personal newsletter" class="newsletter absolute">
                <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
